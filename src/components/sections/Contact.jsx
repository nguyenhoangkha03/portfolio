          ...
          <div className="grid lg:grid-cols-2 gap-12">
            <motion.div variants={itemVariants}>
              <Card>
                ...
                {submitStatus && (
                  <motion.div
                    className={`mb-6 p-4 rounded-lg flex items-center ${submitStatus === "success"
                ...
                >
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      <label className="block text-sm font-semibold text-gray-900 dark:text-white mb-2">
                        {t(
                          "contact_section.form_firstname"
                        )}{" "}
                        *
                      </label>
                      <input
                  ...
                  <div>
                    ...
                    <input
                      ...
                      {...register("user_email", {
                        required: t(
                          "contact_section.form_email_error"
                        ),
                        pattern: {
                          value: /^[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,}$/i,
                          message: t(
                            "contact_section.form_email_invalid"
                          ),
                        },
                      })}
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      {...register("message", {
                        required: t(
                          "contact_section.form_message_error"
                        ),
                        minLength: {
                          value: 10,
                          message: t(
                            "contact_section.form_message_minlength"
                          ),
                        },
                      })}
                  ...
                  >
                    {isSubmitting ? (
                      ...
                      <>
                        ...
                        />
                        {t(
                          "contact_section.form_send_message"
                        )}
                      </>
                    )}
                  </Button>
                ...
                <div className="space-y-6">
                  {contactMethods.map((method, index) => {
                    ...
                    return (
                      ...
                      >
                        <div
                          className={`p-3 rounded-full bg-white dark:bg-gray-900 mr-4 ${method.color} group-hover:scale-110 transition-transform duration-200`}
                        >
